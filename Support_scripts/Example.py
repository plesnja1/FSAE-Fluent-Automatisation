...
design.create_named_selection("tunnel_inlet", faces=[tunnel_inlet])
design.create_named_selection("tunnel_outlet", faces=[tunnel_outlet])
design.create_named_selection("tunnel_top", faces=[tunnel_top])
design.create_named_selection("tunnel_road", faces=[tunnel_road])
design.create_named_selection("tunnel_symm1", faces=[tunnel_symm1])
design.create_named_selection("tunnel_symm2", faces=[tunnel_symm2])
